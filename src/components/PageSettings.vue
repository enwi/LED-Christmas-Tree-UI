	...
	<div class="main">
		...
		<table class="container">
			<tr>
				...
				<td class="border">
					<Selector :value="wifi_mode" @input="set_wifi_mode" :choices="[{'name':'Client', value:'client'},{'name':'Access point', value:'ap'}]"></Selector>
				</td>
			</tr>
			...
			<tr>
				...
				<td class="border">
					<table class="container-full">
						<tr>
							<td>Enabled</td>
							<td style="width: 100%"><SlideSwitch v-model="config.mqtt.enabled"></SlideSwitch></td>
						</tr>
