                ...
                <td class="border">
                    <table class="container-full">
                        ...
                        <tr>
                            <td>Password</td>
                            <td>
                                <FakePwInput v-model="client_pw_text"></FakePwInput>
                            </td>
                        </tr>
                        <tr>
                            <td>DHCP</td>
                            <td>
                                <SlideSwitch v-model="config.wifi.client_dhcp_enabled"></SlideSwitch>
                            </td>
                        </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <TextInput :hidden="true"
                                               v-model="config.mqtt.password"></TextInput>
                                </td>
                            </tr>
                        </template>
                    </table>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            client_pw_text: {
                get() {
                    if (this.config.wifi.client_has_password) {
                        return this.config.wifi.client_password;
                    } else {
                        return "";
                    }
                },
                set(value) {
                    this.config.wifi.client_has_password = (value != "");
                    this.config.wifi.client_password = value;
                }
            },
            ap_pw_text: {
                get() {
                    if (this.config.wifi.ap_has_password) {
                        return this.config.wifi.ap_password;
                    } else {
                        return "";
                    }
                },
                set(value) {
                    this.config.wifi.ap_has_password = (value != "");
                    this.config.wifi.ap_password = value;
                }
            }
        },
        data() {
